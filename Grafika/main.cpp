	...
	while (quit == false)
	{
		...
		while (SDL_PollEvent(&event))
		{
			...
			else if (event.type == SDL_KEYDOWN)
			{
				...
				if (start == true) {
					if (event.key.keysym.sym == SDLK_l) renderer->SetRenderingMode(Renderer::RENDERING_MODE::LINES);
					...
					{
						renderer->TileMoveForward(true);
					}
					else if (event.key.keysym.sym == SDLK_DOWN)
					{
						renderer->TileMoveBackWard(true);
					}
					else if (event.key.keysym.sym == SDLK_LEFT)
					{
						renderer->TileMoveLeft(true);
					}
					else if (event.key.keysym.sym == SDLK_RIGHT)
					{
						renderer->TileMoveRight(true);
					}
				}
			}
			else if (event.type == SDL_KEYUP)
			{
				if (start == true) {
					...
					{
						renderer->TileMoveForward(false);
					}
					else if (event.key.keysym.sym == SDLK_DOWN)
					{
						renderer->TileMoveBackWard(false);
					}
					else if (event.key.keysym.sym == SDLK_LEFT)
					{
						renderer->TileMoveLeft(false);
					}
					else if (event.key.keysym.sym == SDLK_RIGHT)
					{
						renderer->TileMoveRight(false);
					}
				}
			}
